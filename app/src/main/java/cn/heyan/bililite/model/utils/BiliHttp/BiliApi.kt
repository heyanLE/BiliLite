 ...
 */
 object BiliApi{
    ...
    fun getPartListHot(page:String,part:String,sort:String,timeFrom:String,timeTo:String)
            = "https://s.search.bilibili.com/cate/search?callback=result&main_ver=v3&search_type=video&view_type=hot_rank&order=${sort}&copy_right=-1&cate_id=${part}&page=${page}&pagesize=20&jsonp=json&time_from=${timeFrom}&time_to=${timeTo}&_=1518609758676"
